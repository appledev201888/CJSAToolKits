...
Pod::Spec.new do |s|
  ...
  s.name         = "CJSAToolKits"
  s.version      = "0.0.1"
  s.summary      = "A short description of CJSAToolKits."
...
12345567890
  ...
  s.homepage     = "https://github.com/appledev201888/CJSAToolKits"
  ...
  s.source       = { :git => "https://github.com/appledev201888/CJSAToolKits.git", :tag => "#{s.version}" }
